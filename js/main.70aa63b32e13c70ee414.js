...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header{background-color:#23180d;height:64px}.brand-logo{margin-left:10px}.brand-logo #logo{margin-top:14px}.content.container{min-height:calc(100vh - 70px - 64px);padding-top:10px;display:flex;flex-wrap:wrap;justify-content:space-start;position:relative}.content.container .title-div{display:block !important;width:100%;margin-top:1px !important}.content.container .title-div .h2-title{color:#d88b3e;text-align:center;margin-top:1px !important}.content.container hr{display:block !important;margin-top:-5px;margin-bottom:17px;border:0;height:2px;width:30%;background:#000;background-image:-webkit-linear-gradient(left, #fff, rgb(141, 141, 141), #fff)}.content.container .support-msg{transition:all .5s;position:fixed;bottom:-14px;right:0px;z-index:10;animation:slidein .5s ease-in-out}.content.container .support-msg .img-coock{width:100%;height:100%;max-width:100px;max-height:100px}@keyframes slidein{from{right:-800px}to{right:0px}}.page-footer{background-color:#23180d;min-height:70px}.page-footer .footer-flex{display:flex;justify-content:space-around}.content-wrapper{display:flex;flex-wrap:wrap;justify-content:flex-start;margin-right:0px !important}.card{flex:0 1 24%;display:flex;flex-direction:column;margin-right:5px;margin-left:5px;min-height:400px;min-width:300px}@media screen and (max-width: 1800px){.card{flex:0 1 32%}}@media screen and (max-width: 1346px){.card{flex:0 1 48%}}@media screen and (max-width: 746px){.card{flex:0 0 99%}}.card .card-title{color:#23180d !important}@media screen and (max-width: 370px){.card{min-height:300px;min-width:250px}}.card .category-btn{background-color:#d88b3e !important}.card-content{flex-grow:1}#strMeal{color:#d88b3e !important;text-align:center;margin-top:0px}@media screen and (max-width: 653px){#strMeal{font-size:35px}}.meals-list{width:100%}.recipe__item{display:flex;justify-content:center;margin-top:50px}@media screen and (max-width: 653px){.recipe__item{flex-direction:column}}.recipe__item .recipe__item-desc{margin-left:33px;display:flex;flex-direction:column;justify-content:center}.recipe__item .recipe__item-desc .desc{font-size:23px}.recipe__item .recipe__item-desc .desc .icon-desc{margin-right:4px}.recipe__item .recipe__item-desc #strCategory{margin-bottom:15px}.description__text{font-size:20px}.title{color:#d88b3e !important;text-align:center;margin-top:40px}img#strMealThumb{width:600px;max-height:400px;border-radius:5px;max-width:100%;box-shadow:0 0 10px 5px #ddd}@media screen and (max-width: 653px){img#strMealThumb{margin-top:-24px}}.iframe-wrapper{text-align:center}.iframe-wrapper iframe{width:700px;height:400px;margin-bottom:40px;margin-top:20px;max-width:100%}.back-btn{margin:0px auto;margin-bottom:20px;width:400px}.row-search{width:100vh;display:block}.not-found{width:100%}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./src/assets/img/footer1.png
const footer1_namespaceObject = __webpack_require__.p + "assets/images/footer1-41915971084e68cfbe0f.png";
;// CONCATENATED MODULE: ./src/assets/img/footer2.png
const footer2_namespaceObject = __webpack_require__.p + "assets/images/footer2-8d02468446cd54d0ea14.png";
;// CONCATENATED MODULE: ./src/assets/img/footer3.png
const footer3_namespaceObject = __webpack_require__.p + "assets/images/footer3-3cc326dab55a95491ed7.png";
;// CONCATENATED MODULE: ./src/js/components/Footer.jsx
...
function Footer() {
  ...
  }, "\xA9 ", new Date().getFullYear(), " Copyright Text"), /*#__PURE__*/react.createElement("div", {
    style: {
      display: "inline-block"
    },
    className: "img-wrapper"
  }, /*#__PURE__*/react.createElement("img", {
    src: footer1_namespaceObject
  }), /*#__PURE__*/react.createElement("img", {
    src: footer2_namespaceObject
  }), /*#__PURE__*/react.createElement("img", {
    src: footer3_namespaceObject
...
const logo_namespaceObject = __webpack_require__.p + "assets/images/logo-7d243edf052a9de2a6d2.png";
;// CONCATENATED MODULE: ./src/js/components/Header.jsx
...
function Header() {
  ...
  return /*#__PURE__*/react.createElement("nav", {
    ...
    to: "/contact"
  }, "Contacts")), /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement(Link, {
    to: "/about"
  }, "About us")))));
}
...
;// CONCATENATED MODULE: ./src/js/components/Preloader.jsx
...
;// CONCATENATED MODULE: ./src/js/components/CategoryItem.jsx
...
const CategoryItem = props => {
  ...
  }, strCategory), /*#__PURE__*/React.createElement("p", null, strCategoryDescription.slice(0, 60), "...")), /*#__PURE__*/React.createElement("div", {
...
;// CONCATENATED MODULE: ./src/js/components/CategoryList.jsx
function CategoryList_extends() { CategoryList_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return CategoryList_extends.apply(this, arguments); }
...
const CategoryList = props => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "categories-wrapper content-wrapper"
  }, categories.map(el => /*#__PURE__*/React.createElement(CategoryItem, CategoryList_extends({
    key: el.idCategory
  }, el))));
};


;// CONCATENATED MODULE: ./src/assets/img/coock.png
const coock_namespaceObject = __webpack_require__.p + "assets/images/coock-64dc75b771a50302053a.png";
;// CONCATENATED MODULE: ./src/js/components/CategoryTitle.jsx
...
;// CONCATENATED MODULE: ./src/js/components/Search.jsx
...
;// CONCATENATED MODULE: ./src/js/components/Main.jsx
...
const Main = () => {
  ...
  const [filteredCategories, setFilteredCategories] = (0,react.useState)([]);
  const [alertCategory, setAlertCategory] = (0,react.useState)(true);
  const {
    pathname,
    search
  } = react_router_useLocation();
  ...
  (0,react.useEffect)(() => {
    getAllCategories().then(data => {
      ...
      setFilteredCategories(search.length > 8 ? data.categories.filter(item => {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, categories.length ? /*#__PURE__*/react.createElement(react.Fragment, null, !filteredCategories.length ? /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Search, {
    cb: handleSearch
...
;// CONCATENATED MODULE: ./src/js/pages/About.jsx
const About = () => {
  return /*#__PURE__*/React.createElement("h1", null, "About us");
};


;// CONCATENATED MODULE: ./src/js/pages/Contact.jsx
const Contact = () => {
  return /*#__PURE__*/React.createElement("h1", null, "Contact us");
};


;// CONCATENATED MODULE: ./src/js/pages/NotFound.jsx
const NotFound = () => {
  return /*#__PURE__*/React.createElement("h1", null, "Page is not found");
};


;// CONCATENATED MODULE: ./src/js/components/Meal.jsx
...
;// CONCATENATED MODULE: ./src/js/components/MealsList.jsx
function MealsList_extends() { MealsList_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return MealsList_extends.apply(this, arguments); }
...
const MealsList = props => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "meals-wrapper content-wrapper"
  }, meals.map(el => /*#__PURE__*/React.createElement(Meal, MealsList_extends({
    key: el.idMeal
  }, el))), !meals.length ? /*#__PURE__*/React.createElement("h1", null, "Not found") : null);
};


;// CONCATENATED MODULE: ./src/js/pages/Category.jsx
...
const Category = () => {
  const [meals, setMeals] = (0,react.useState)([]);
  const [filteredMeals, setFilteredMeals] = (0,react.useState)([]);
  const {
    name
  } = useParams();
  const navigate = react_router_useNavigate();
  ...
  const handleSearch = str => {
    setFilteredMeals(meals.filter(item => {
  ...
  (0,react.useEffect)(() => {
    ...
    getFilterByCategory(name).then(data => {
      setMeals(data.meals);
      setFilteredMeals(search.length > 8 ? data.meals.filter(item => {
        return item.strMeal.toLowerCase().includes(search.split("=")[1].toLowerCase());
      }) : data.meals);
    });
  }, [name]);
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "categories-title h2-title"
  }, "Recipes ", name, "`s"), /*#__PURE__*/React.createElement(Search, {
    cb: handleSearch
  })), " ", /*#__PURE__*/React.createElement("div", {
    className: "meals-list"
  }, !meals.length ? /*#__PURE__*/React.createElement(Preloader, null) : /*#__PURE__*/React.createElement(MealsList, {
    meals: filteredMeals
  })), meals.length && /*#__PURE__*/React.createElement("button", {
    onClick: () => navigate(-1),
...
;// CONCATENATED MODULE: ./src/js/pages/Recipe.jsx
...
const Recipe = () => {
  const [recipe, setRecipe] = (0,react.useState)([]);
  const {
    id
  } = useParams();
  const navigate = react_router_useNavigate();
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !recipe ? /*#__PURE__*/React.createElement(Preloader, null) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "recipe__item-desc"
  }, /*#__PURE__*/React.createElement("h6", {
    id: "strCategory",
    className: "desc"
  }, /*#__PURE__*/React.createElement("i", {
    className: "material-icons icon-desc"
  }, "restaurant_menu"), "Category: ", recipe.strCategory), recipe.strArea ? /*#__PURE__*/React.createElement("h6", {
    id: "strArea",
    className: "desc"
  }, /*#__PURE__*/React.createElement("i", {
    className: "material-icons icon-desc"
  }, "add_location"), "Area: ", recipe.strArea) : null)), /*#__PURE__*/React.createElement("div", {
    className: "description"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "description__title title"
    ...
    className: "ingridients__title title"
  }, "Ingridients"), /*#__PURE__*/React.createElement("table", {
    className: "centered"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "Food product"), /*#__PURE__*/React.createElement("th", null, "Amount"))), /*#__PURE__*/React.createElement("tbody", null, Object.keys(recipe).map(key => {
    if (key.includes("strIngredient") && recipe[key]) {
      return /*#__PURE__*/React.createElement("tr", {
        key: key
      }, /*#__PURE__*/React.createElement("td", null, recipe[key]), /*#__PURE__*/React.createElement("td", null, recipe[`strMeasure${key.slice(13)}`]));
    } else return null;
  })))), recipe.strYoutube ? /*#__PURE__*/React.createElement("div", {
    className: "iframe-wrapper"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "iframe__title title"
  }, "Video instruction"), /*#__PURE__*/React.createElement("iframe", {
    title: recipe.strMeal,
    src: "https://www.youtube.com/embed/" + recipe.strYoutube.slice(-11),
    allowFullScreen: true
  })) : null), recipe.strInstructions && /*#__PURE__*/React.createElement("button", {
    onClick: () => navigate(-1),
    className: "btn back-btn"
  }, "Go back")));
};
...
;// CONCATENATED MODULE: ./src/js/App.jsx
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/main.scss
var main = __webpack_require__(9119);
;// CONCATENATED MODULE: ./src/assets/scss/main.scss
...
var update = injectStylesIntoStyleTag_default()(main/* default */.Z, options);
       ...
       /* harmony default export */ const scss_main = (main/* default */.Z && main/* default.locals */.Z.locals ? main/* default.locals */.Z.locals : undefined);
